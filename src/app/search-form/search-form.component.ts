...
import { Category, SizeProduct, brand, product } from '../Model/product.model';
...
export class SearchFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.WishListService.Search.subscribe((c) => {
      this.search = c;
    });
    this.GetCategory();
    this.GetBrand();
  ...
  GetProduct() {
    this.productServices.GetSearchProduct(this.search).subscribe({
      next: (product) => {
